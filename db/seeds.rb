...
Producto.create!(nombre: 'Codigo de prueba', titular: 'Prueba de producto codigo', descripcion: 'Esto es un producto de prueba, vendiendo codigos de prueba', precio: 10, estado: 'activo', stock: 2, tipoProducto: 'codigo', imagen: "/assets/images/codigo-qr.jpg")
Codigo.create!(codigo: '01234', vendido: true, producto_id: 1, pedido_id: 1)
Codigo.create!(codigo: '01235', vendido: false, producto_id: 1, pedido_id: 1)
Codigo.create!(codigo: '01236', vendido: false, producto_id: 1, pedido_id: 1)
...
Producto.create!(nombre: 'Entrada de prueba', titular: 'Prueba de producto entrada', descripcion: 'Esto es un producto de prueba, vendiendo entradas de prueba', precio: 10, estado: 'activo', stock: 2, tipoProducto: 'entrada', imagen: "/assets/images/news_entrada.jpg")
Entrada.create!(codigo: '01234', vendido: true, producto_id: 2, pedido_id: 2)
Entrada.create!(codigo: '01235', vendido: false, producto_id: 2, pedido_id: 2)
Entrada.create!(codigo: '01236', vendido: false, producto_id: 2, pedido_id: 2)
