...
Producto.create!(nombre: 'Codigo de prueba', titular: 'Prueba de producto codigo', descripcion: 'Esto es un producto de prueba, vendiendo codigos de prueba', precio: 10, estado: 'activo', stock: 2, tipoProducto: 'codigo', imagen: "codigo-qr.jpg")
