...
Pedido.create!(Usuario: 'Usuario Prueba', Mail: 'ejemplo@ejemplo.com', Precio: 10, facturas_id:1)
...
Pedido.create!(Usuario: 'Usuario Prueba', Mail: 'ejemplo@ejemplo.com', Precio: 10, facturas_id:2)
